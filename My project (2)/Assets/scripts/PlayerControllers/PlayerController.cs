...
public class PlayerController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        sr.sortingLayerID = SortingLayer.NameToID("GamePlay");
        sr.sortingOrder = 10; // 优先级高于地板/金币，确保玩家在最前
        transform.position = new Vector3(transform.position.x, transform.position.y, 0f); // 玩家Z轴=0
    }
